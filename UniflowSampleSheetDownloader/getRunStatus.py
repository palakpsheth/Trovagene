...
sys.path.append( os.path.join( os.path.dirname( os.path.dirname(os.path.realpath(__file__) ) ), 'TrovaWrapper' ) )
...
configFile = os.path.realpath( os.path.join( os.path.dirname(__file__), 'config.ini' ) )
...
def Usage() :
	print "python getExperimentStatus.py flowcell_ID"
